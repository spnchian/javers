...
public class CustomComparators {
    ...
    CustomComparators(List<CustomToNativeAppenderAdapter<?, ? extends PropertyChange>> customComparators,
                      List<CustomToNativeAppenderAdapter<?, ValueChange>> valueChangeCustomComparators) {
        this.customComparators = customComparators;
        this.valueChangeCustomComparators = valueChangeCustomComparators;
    }
